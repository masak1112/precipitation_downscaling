...
checkpoint_dir=../results/exp_20230421_epoch20_repeat2_n8/341980_G.pth
save_dir=../results/exp_20230421_epoch20_repeat2_n8_postprocess
model_type=unet

srun --overlap python ../main_scripts/main_test.py --test_dir ${test_dir} --stat_dir ${train_dir} --checkpoint_dir ${checkpoint_dir}  --save_dir ${save_dir} --model_type ${model_type} 
