...
class PrecipDatasetInter(torch.utils.data.IterableDataset):
    ...
    def __init__(self, file_path: str = None, 
        ...
        stat_file = os.path.join(self.stat_path, "statistics.json")


        #get the topography dataset
        self.dt_top = xr.open_dataset("/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/ShiXiSheng/yzy/downscaling_precipitation/precip_dataset_new/topography_srtm_ifs2radklim.nc")
...
def run():
    data_loader = PrecipDatasetInter(
        file_path="/cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/ShiXiSheng/yzy/downscaling_precipitation/precip_dataset_new/train_small",
    ...
    for batch_idx, train_data in enumerate(data_loader):
        ...
        # ogr = train_data["H_orig"]
        # print("ogr shape:", ogr.shape)
