...
def run(train_dir: str = "/p/scratch/deepacf/deeprain/bing/downscaling_maelstrom/train",
    ...
    if type_net == "wgan":
        hparams = {"critic_iterations": 5, "lr_gn": 1.e-05, 
                  ...
                  "lambada_gp":10, "recon_weight":950}
...
def main():
    '''
    python 
    precipitation_downscaling-bing_issue09_bias_correction/main_scripts/main_train.py 
    --train_dir /cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/ShiXiSheng/yzy/downscaling_precipitation/precip_dataset_new/train_small
    --val_dir /cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/ShiXiSheng/yzy/downscaling_precipitation/precip_dataset_new/val/2017-01
    --save_dir /cpfs01/projects-HDD/cfff-4a8d9af84f66_HDD/public/ShiXiSheng/yzy/downscaling_precipitation/precip_dataset_new/train_small/results_demo1
    '''
    ...
    parser.add_argument("--epochs", type = int, default = 25, help = "The checkpoint directory")
    ...
    parser.add_argument("--k", type=float, default=0.01,help="log transform")
